...
@router.post(
    ...
    description="Predict energy consumption from current conditions using the Random Forest model (~94.2% accuracy)."
)
async def predict_consumption(
    ...
    Uses the Random Forest regressor trained on the sample dataset.
